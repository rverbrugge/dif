...
Utils::debug(sprintf("%s : Executed in %s seconds (%s). Memory usage: %s", $request->getPath(), $timer->getTime(), $cache->isCached() ? 'CACHED' : 'GENERATED', memory_get_usage()/1024/1024), 'timer.log');
*/
?>
