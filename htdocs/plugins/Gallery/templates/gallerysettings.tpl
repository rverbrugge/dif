...
<?  /*-----conf edit {{{------*/
if($currentView == Gallery::VIEW_CONFIG):?>
<p class="options">
...
<table id="form">
	...
	<tr><th>Overview display style</th>			<td><select size="1" name="display_overview"><?=$cbo_display_overview;?></select></td></tr>
	...
	<tr><th>Caption previous link</th>					<td><input type="text" name="cap_previous" value="<?=$cap_previous;?>" size="75" /></td></tr>
	<tr><th>Caption next link</th>					<td><input type="text" name="cap_next" value="<?=$cap_next;?>" size="75" /></td></tr>
