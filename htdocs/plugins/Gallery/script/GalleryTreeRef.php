 ...
 * @package Common
 */
class GalleryTreeRef extends DbConnector
{
	/**
	 * Constructor
	 *
	...
	public function __construct()
	{
		...
		$this->sqlParser->setTable('gallery_tree_ref', 'a');
		...
		$this->sqlParser->addField(new SqlField('a', 'gal_ref_tree_id', 'ref_tree_id', 'Node', SqlParser::getTypeSelect()|SqlParser::getTypeModify()|SqlParser::PKEY, SqlField::TYPE_INTEGER, true));
