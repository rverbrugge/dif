 ...
 * @package Common
 */
class GallerySettings extends Observer
{
	/**
	...
	public function __construct($plugin)
	{
		...
		$this->template = array();
		$this->templateFile = "gallerysettings.tpl";
		$this->basePath = realpath(dirname(__FILE__)."/../")."/";

		$this->sqlParser->setSelect('select');
		$this->sqlParser->setTable('gallery_overview_settings', 'a');
		...
		$this->sqlParser->addField(new SqlField('a', 'set_display_overview', 'display_overview', 'Display overview', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_INTEGER, true));
		...
		$this->sqlParser->addField(new SqlField('a', 'set_cap_previous', 'cap_previous', 'Caption previous link', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_STRING));
		$this->sqlParser->addField(new SqlField('a', 'set_cap_next', 'cap_next', 'Caption next link', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_STRING));
...
/*----- handle http requests {{{ -------*/
	...
	public function handleHttpPostRequest()
	{
		...
		{
			case Gallery::VIEW_CONFIG : $this->handleConfigPost(); break;
		}
	...
	public function handleHttpGetRequest()
	{
		...
		switch($viewManager->getType())
		{
			case Gallery::VIEW_CONFIG : $this->handleConfigGet(); break;
		}
	}
//}}}
