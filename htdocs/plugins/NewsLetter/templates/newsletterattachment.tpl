...
<?  /*-----tree overview {{{------*/
if($currentView == NewsLetter::VIEW_FILE_OVERVIEW):?>
<p class="options">
...
<?  /*-----tree new and edit {{{------*/
if($currentView == NewsLetter::VIEW_FILE_NEW || $currentView == NewsLetter::VIEW_FILE_EDIT):?>
...
<?  /*-----delete {{{------*/
if($currentView == NewsLetter::VIEW_FILE_DELETE):?>
...
<?  /*-----overview {{{------*/
if($currentView == ViewManager::OVERVIEW || $currentView == NewsLetter::VIEW_DETAIL):?>
...
<?  /*----- import {{{------*/
if($currentView == NewsLetter::VIEW_FILE_IMPORT):?>
