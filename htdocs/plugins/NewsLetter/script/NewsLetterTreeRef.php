 ...
 * @package Common
 */
class NewsLetterTreeRef extends DbConnector
{
	/**
	 * Constructor
	 *
	...
	public function __construct()
	{
		...
		$this->sqlParser->setTable('newsletter_tree_ref', 'a');
		...
		$this->sqlParser->addField(new SqlField('a', 'nl_ref_tree_id', 'ref_tree_id', 'Node', SqlParser::getTypeSelect()|SqlParser::getTypeModify()|SqlParser::PKEY, SqlField::TYPE_INTEGER, true));
