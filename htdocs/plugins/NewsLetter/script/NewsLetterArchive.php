 ...
 * @package Common
 */
class NewsLetterArchive extends Observer
{
	...
	public function __construct($plugin)
	{
		...
		$this->template = array();
		$this->templateFile = "newsletterarchive.tpl";
		$this->basePath = realpath(dirname(__FILE__)."/../")."/";
		$this->reference = array();

		$this->sqlParser->setSelect('select');
		$this->sqlParser->setTable('newsletter_archive', 'a');
		$this->sqlParser->addField(new SqlField('a', 'nl_tree_id', 'tree_id', 'Node', SqlParser::getTypeSelect()|SqlParser::getTypeModify()|SqlParser::PKEY, SqlField::TYPE_INTEGER, true));
		$this->sqlParser->addField(new SqlField('a', 'nl_tag', 'tag', 'Tag', SqlParser::getTypeSelect()|SqlParser::getTypeModify()|SqlParser::PKEY, SqlField::TYPE_STRING, true));
		$this->sqlParser->addField(new SqlField('a', 'nl_online', 'online', 'Online datum', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_DATE));
		...
		$this->sqlParser->addField(new SqlField('a', 'nl_usr_id', 'usr_id', 'Gebruiker', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_INTEGER, true));
		$this->sqlParser->addField(new SqlField('a', 'nl_own_id', 'own_id', 'Eigenaar', SqlParser::getTypeSelect()|SqlParser::MOD_INSERT, SqlField::TYPE_INTEGER, true));
		$this->sqlParser->addField(new SqlField('a', 'nl_create', 'createdate', 'Creatie', SqlParser::getTypeSelect()|SqlParser::MOD_INSERT, SqlField::TYPE_DATE, true));
		$this->sqlParser->addField(new SqlField('a', 'nl_ts', 'ts', 'Gewijzigd', SqlParser::getTypeSelect(), SqlField::TYPE_DATE));
	}
...
/*-------- helper functions {{{----------*/
	...
	private function getNewsLetterOverview()
	{
		if(isset($this->newsLetterOverview)) return $this->newsLetterOverview;

		require_once('NewsLetterOverview.php');
		$this->newsLetterOverview = new NewsLetterOverview($this->plugin);
		return $this->newsLetterOverview;
	}
...
/*------- tree edit request {{{ -------*/
	...
	*/
	private function handleTreeEditGet($retrieveFields=true)
	{
		...
		$searchcriteria = array('classname' => 'NewsLetter',
														'plugin_type'			=> NewsLetter::TYPE_DEFAULT);
