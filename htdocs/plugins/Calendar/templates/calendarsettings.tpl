...
<?  /*-----conf edit {{{------*/
if($currentView == Calendar::VIEW_CONFIG):?>
<p class="options">
...
<table id="form">
	...
	<tr><th>Show expired items</th>							<td><input type="text" class="date" id="history" name="history" value="<?=$history;?>" size="15" /></td></tr>
	<tr><th>Expired item comment</th>					<td><input type="text" name="history_comment" value="<?=$history_comment;?>" size="75" /></td></tr>
