 ...
 * @package Common
 */
class CalendarSettings extends Observer
{
	/**
	...
	public function __construct($plugin)
	{
		...
		$this->template = array();
		$this->templateFile = "calendarsettings.tpl";
		$this->basePath = realpath(dirname(__FILE__)."/../")."/";

		$this->sqlParser->setSelect('select');
		$this->sqlParser->setTable('calendar_overview_settings', 'a');
		...
		$this->sqlParser->addField(new SqlField('a', 'set_history', 'history', 'Show history', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_DATE));
		$this->sqlParser->addField(new SqlField('a', 'set_history_comment', 'history_comment', 'History comment', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_STRING));
		$this->sqlParser->addField(new SqlField('a', 'set_group', 'group_type', 'Groepering', SqlParser::getTypeSelect()|SqlParser::getTypeModify(), SqlField::TYPE_INTEGER));
...
/*----- handle http requests {{{ -------*/
	...
	public function handleHttpPostRequest()
	{
		...
		{
			case Calendar::VIEW_CONFIG : $this->handleConfigPost(); break;
		}
	...
	public function handleHttpGetRequest()
	{
		...
		switch($viewManager->getType())
		{
			case Calendar::VIEW_CONFIG : $this->handleConfigGet(); break;
		}
	}
//}}}
